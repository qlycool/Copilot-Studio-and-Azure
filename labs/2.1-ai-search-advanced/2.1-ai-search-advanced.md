...
1. Open **Copilot Studio** and navigate to your **Agent** created in **Lab 0.0 - Create an agent**.
   ...
   <img src="../2.1-ai-search-advanced/images/01.png" width="100%" height="100%">
...
1. Set the system prompt for the agent in the instructions section as below:
   ...
   <img src="../2.1-ai-search-advanced/images/02.png" width="100%" height="100%">
...
2. In the **Knowledge** tab, click on **+ Add knowledge** button to connect Azure AI Search as knowledge source.
   ...
   <img src="../2.1-ai-search-advanced/images/03.png" width="100%" height="100%">

   <br>

3. In the dialog that appears, select **Azure AI Search**.

   <img src="../2.1-ai-search-advanced/images/04.png" width="100%" height="100%">

   <br>

4. Select the index you created in Exercise 1 - Task 3 from the options available, and clink **Add to agent**.

   <img src="../2.1-ai-search-advanced/images/05.png" width="100%" height="100%">
...
1. Go to the **Test your agent** pane to test your agent. You can ask questions related to the documents you uploaded to Azure AI Search in Exercise 1 - Task 1. (eg. What can I do at the hotel?)
   ...
   <img src="../2.1-ai-search-advanced/images/06.png" width="100%" height="100%">

   <br>

2. You will see the executed queries and the answers provided by the agent.

   <img src="../2.1-ai-search-advanced/images/07.png" width="100%" height="100%">

   <br>

### OPTION 2: Connect Azure AI Search using a custom HTTP Connector
### Task 1: Create an Agent flow with HTTP Connector

1. In **Copilot Studio**, navigate to **Flows** and click on **+ New agent flow**.

   <img src="../2.1-ai-search-advanced/images/08.png" width="100%" height="100%">

   <br>

2. In the **Designer** tab, you will see a default **Add a trigger** block. Select **When an agent calls the flow**.

   <img src="../2.1-ai-search-advanced/images/09.png" width="100%" height="100%">

   <br>

3. Next, click on the **+** icon below the trigger block to add a new action. 

   <img src="../2.1-ai-search-advanced/images/10.png" width="100%" height="100%">

   <br>

4. In the **Choose an action** pane, search for **HTTP** and select the **HTTP** action.

    <img src="../2.1-ai-search-advanced/images/11.png" width="100%" height="100%">
...
6. Next, click on the **+** icon below the trigger block to add a new action. 
   ...
   <img src="../2.1-ai-search-advanced/images/12.png" width="100%" height="100%">

   <br>

7. In the **Choose an action** pane, search for **Respond** and select the **Respond to the agent** action.

    <img src="../2.1-ai-search-advanced/images/13.png" width="100%" height="100%">
  
    <br>

8. Click on **Add an output** and select **Text**. Set the values as below:

   <img src="../2.1-ai-search-advanced/images/14.png" width="100%" height="100%">

   <br>

   <img src="../2.1-ai-search-advanced/images/15.png" width="100%" height="100%">

   <br>

     <img src="../2.1-ai-search-advanced/images/16.png" width="100%" height="100%">

   <br>

9. **Publish** the flow by clicking on the **Publish** button at the top right corner.

   <img src="../2.1-ai-search-advanced/images/17.png" width="100%" height="100%">
...
2. You will see the executed queries and the answers provided by the agent.
   ...
   <img src="../2.1-ai-search-advanced/images/21.png" width="100%" height="100%">
